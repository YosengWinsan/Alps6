...
import { AlpsEditActionToolbarComponent } from './alps-edit-action-toolbar/alps-edit-action-toolbar.component';
@NgModule({
  imports: [
  ...
  exports: [AlpsSelectorComponent, AlpsEditToolbarComponent, AlpsInfoChipComponent, NgForObjPipe, EnterToTabDirective, AlpsMenuSelectorComponent, AlpsNavBarComponent, AlpsCommodityCatagorySelectorComponent
    , AlpsShopcartComponent, MatFormFieldModule, MatTableModule, MatIconModule, MatInputModule, MatButtonModule, AlpsPrintComponent, AlpsSearchSelectorComponent,AlpsEditActionToolbarComponent],
  declarations: [AlpsSelectorComponent, AlpsSelectorDialogComponent, AlpsEditToolbarComponent, AlpsInfoChipComponent, NgForObjPipe, AlpsLoadingBarComponent
    , EnterToTabDirective, AlpsMenuSelectorComponent, AlpsNavBarComponent, AlpsCommodityCatagorySelectorComponent, AlpsShopcartComponent, AlpsPrintComponent, AlpsSearchSelectorComponent, EnumFormatPipe, AlpsEditActionToolbarComponent
