...
import { MatDatepickerModule, MatNativeDateModule } from '../../../node_modules/@angular/material';
...
@NgModule({
  imports: [
    ...
    LoanRoutingModule,ReactiveFormsModule,MatDatepickerModule,MatNativeDateModule
  ],
