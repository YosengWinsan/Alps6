...
const MENU_DATA: MenuItem[] = [
  ...
  { path: "stock", name: "仓库管理" ,children:[{path:"stock/stockin",name:"入库"},{path:"stock/stockout",name:"出库"},{path:"stock/stockinlist",name:"入库明细"},{path:"stock/stockoutlist",name:"出库明细"}]},
