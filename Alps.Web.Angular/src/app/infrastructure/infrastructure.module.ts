...
import { MatDialogModule, MatButtonModule, MatIconModule, MatProgressSpinnerModule, MatMenuModule, MatExpansionModule, MatTableModule, MatFormFieldModule, MatInputModule } from '@angular/material';
...
@NgModule({
  ...
  ,AlpsShopcartComponent,MatFormFieldModule,MatTableModule,MatIconModule,MatInputModule,MatButtonModule,AlpsPrintComponent],
...
,EnterToTabDirective, AlpsMenuSelectorComponent, AlpsNavBarComponent, AlpsCommodityCatagorySelectorComponent,  AlpsShopcartComponent, AlpsPrintComponent
  ],
