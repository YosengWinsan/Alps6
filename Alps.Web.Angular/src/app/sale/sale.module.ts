...
@NgModule({
  ...
  declarations: [CommodityListComponent, SaleOrderListComponent, SaleOrderEditComponent, CommodityEditComponent, SaleOrderItemEditComponent, SaleOrderDetailComponent],
